...
<<<<<<< HEAD
 ...
 Для создания веток используй команду git branch с параметром name
    
## Слияние веток 

Для слияния веток используй комманду git merge
=======
## Создание веток

Для создания веток в git  исрользуй команду git branch с параметром name
